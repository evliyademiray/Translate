...
export const translateSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(getLanguages.fulfilled, (state, action) => {
      ...
      (state.isLangsError = false), (state.languages = action.payload);
    });
    ...
    builder.addCase(translateText.rejected, (state) => {
      (state.isTranslateLoading = false), (state.isTranslateError = true);
    });
  },
  //Senkron aksiyonlar için yine reducers kullanmaya devam ediyoruz
  reducers: {
